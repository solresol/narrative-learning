...
def generate_schema_sql(
  ...
  primary key (split_id, {obfuscated_primary_key})
    ...
    schema_sql += "  round_id integer generated by default as identity primary key,\n"
    schema_sql += "  round_uuid uuid default gen_random_uuid(),\n"
...
def main():
    ...
    # Insert a new round
    cur.execute(
        f"INSERT INTO {rounds_table} (prompt, split_id) VALUES (%s, %s)",
        (args.prompt, split_id),
    )
