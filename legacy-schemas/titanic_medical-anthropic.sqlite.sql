...
CREATE TABLE inferences (
  ...
  patient_id text references "patients"(patientid),
  narrative_text text,
  llm_stderr text,
  prediction text,
...
CREATE TABLE IF NOT EXISTS "patient_splits" (
  ...
  holdout bool not null default false, validation bool not null default false,
...
CREATE TABLE rounds (
  ...
  split_id integer references splits(split_id),
  prompt text
, reasoning_for_this_prompt text, stderr_from_prompt_creation text);
